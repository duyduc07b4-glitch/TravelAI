...
- 💰 **Chi phí ước tính từng hoạt động + chia đều theo đầu người** — AI ước tính giá mỗi hoạt động/quán ăn ngay trong lịch trình (VD: "Ăn trưa tại Yunangi — 1.500 yên", "Miễn phí"), cộng thành **tổng chi phí cả chuyến** và **chia đều cho số thành viên** để chuẩn bị ngân sách — cập nhật tức thì khi thêm/bớt thành viên, không cần tạo lại lịch trình. Chỉ là ước tính từ hiểu biết chung của AI, không phải giá thật đã kiểm chứng, và chưa gồm vé máy bay/khách sạn. 3 phương án A/B/C ở tab Quyết định nhóm cũng hiện giá ước tính riêng cho từng địa điểm khi dữ liệu tham khảo có giá.
