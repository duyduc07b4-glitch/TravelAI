...
- 👥 **Group Decision Engine** — không chỉ chấm điểm, mà còn:
  ...
  - 🔒 **Nhóm phải chọn 1 trong 3 phương án trước khi dùng các tính năng khác** — nút "Tạo lịch trình" (tab Lịch trình), "Tạo lịch trình từ cuộc trò chuyện" (tab Trợ lý giọng nói) và "Chạy self-healing" đều bị khoá cho tới khi ai đó bấm "Chọn phương án này" trên 1 trong 3 card A/B/C. Đúng tinh thần "quyết định nhóm trước, hành động sau" thay vì để 3 phương án chỉ nằm đó cho có. Chọn lại bất cứ lúc nào; đổi địa điểm/thành viên đủ nhiều để phương án cũ không còn hợp lệ sẽ tự khoá lại.
